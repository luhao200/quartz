...
📖 ：[STM32 芯片的 GPIO 被分成很多组，每组有 16 个引脚（也有可能少于 16 个），如型号为 STM32F407ZGT6 型号的芯片有 GPIOA、GPIOB、GPIOC 至 GPIOG 共 7 组 GPIO，芯片一共 144 个引脚，其中 GPIO 就占了一大部分，所有的 GPIO 引脚都有基本的输入输出功能。](../../05Self学习/Embedded/Software/STM32F4/Zassets/[野火EmbedFire]《STM32%20HAL库开发实战指南——基于野火F4系列开发板》—20220913.pdf#page=105&selection=64,0,116,14&color=highlight)

![野火EmbedFire《STM32 HAL库开发实战指南——基于野火F4系列开发板》—20220913](../../05Self学习/Embedded/Software/STM32F4/Zassets/[野火EmbedFire]《STM32%20HAL库开发实战指南——基于野火F4系列开发板》—20220913.pdf#page=106&rect=49,358,558,639&color=highlight)

📖 ：[可以设置“既不上拉也不下拉模式”，我们也把这种状态称为浮空模式，配置成这个模式时，直接用电压表测量其引脚电压为 1 点几伏，这是个不确定值。所以一般来说我们都会选择给引脚设置“上拉模式”或“下拉模式”使它有默认状态。](../../05Self学习/Embedded/Software/STM32F4/Zassets/[野火EmbedFire]《STM32%20HAL库开发实战指南——基于野火F4系列开发板》—20220913.pdf#page=107&selection=22,1,29,22&color=highlight)
